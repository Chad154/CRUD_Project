    ...
    private void handleCreateMovement(ActionEvent event) {
        ...
        try {
            ...
            if ("PAYMENT".equals(cbType.getValue())) {
                if (amountInput > saldoBase) {
                    mostrarError("Fondos insuficientes. Saldo actual: " + saldoBase + " €");
                    return;
                }
            ...
            // 3. CREAR MOVIMIENTO (Con balance congelado)
            ...
            // 4. ACTUALIZAR CUENTA (Usando tu método REST original)
